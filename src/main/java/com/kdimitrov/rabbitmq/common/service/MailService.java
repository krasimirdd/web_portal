...
public class MailService {
    ...
    public void sendEmail(String subject, String messageText, String to) throws MessagingException {
        ...
        helper.setFrom("edentist18@gmail.com");
        helper.setTo(to == null ? this.to : to);
        helper.setSubject(subject);
        helper.setText(messageText, true);
        mailSender.send(mimeMessage);
    }

    public void sendEmail(String subject, Path file, String to, String code) throws MessagingException, IOException {
        MimeMessage mimeMessage = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true);
